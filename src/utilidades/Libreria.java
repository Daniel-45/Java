...
public class Libreria {
	...
	// Pide un número que tiene que estar entre un inicio y un final. Hay que introducir el mensaje a mostrar.
	...
	/**
	 * Da un número aleatorio desde 1, introduciendo el m�ximo primero. Luego desde
